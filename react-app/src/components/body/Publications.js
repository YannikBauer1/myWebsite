...
export default function Publications() {
  ...
  return (
    <div className='pb-5 mb-5' id="publications">
      ...
      <div className='mt-4'>
        <ul class="text-black timeline pe-0 pt-4 pb-1">
                  ...
                  <div class="modal-content">
                    <div class="modal-body p-0">
                      ...
                      <div className='d-flex'>
                        <div className='bg-secondary rounded-start width20 py-3
                        ...
                        <div className='width80 p-3'>
                          <div className='mb-2'>
                            <i className="bi bi-person-lines-fill me-1"></i> {item.authorsComplete}
                          </div>
                          <div className='smallText'>
                            <span className='fw-bold'>Abstract: </span> {item.abstract}
                          </div>
                        </div>
                      </div>
                    </div>
