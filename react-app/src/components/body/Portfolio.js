...
export default function Portfolio() {
  ...
  const items = [
    ...
    },
    {
      ...
      images: ["ric0.png", "ric1.png", "ric2.png", "ric3.png", "ric4.png"],
      tec: ["react", "boostrap"]
    },
    {
      ...
      <div className='d-flex justify-content-center mt-4 pt-2'>
        <div className='width4'>
          {items.map((item, index) => (
            <div className={'d-flex mb-3' + ((index % 2) === 0 ? " " : " flex-row-reverse")}>
              <div class={'text-bg-secondary border-0 portfolioCard shadow-sm rounded-0 p-2 position-relative ' + ((index % 2) === 0 ? "" : "")}>
